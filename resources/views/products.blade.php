    ...
    <div class="container">
        <div class="catalog-grid" id="catalogGrid">
            ...
            $catalogProducts = [
                ...
                ['slug'=>'besi-virkan',     'cat'=>'profil',   'catLabel'=>'Baja Profil',   'name'=>'Besi Virkan (WF)',     'desc'=>'Baja Wide Flange (WF/Besi Virkan) untuk balok dan kolom struktur bangunan bertingkat, jembatan, dan konstruksi berat lainnya.',                               'specs'=>[['Standar','JIS G3101'],['Grade','SS400 / A36'],['Ukuran','WF 100×100 – 400×400'],['Panjang','6m / 9m / 12m']]],
                ...
                ['slug'=>'cnp',             'cat'=>'profil',   'catLabel'=>'Baja Profil',   'name'=>'Kanal CNP',            'desc'=>'Kanal C dengan bibir (CNP/Lips Channel) untuk gording atap, rangka dinding, dan struktur ringan pada bangunan industri dan komersial.',                    'specs'=>[['Standar','SNI / JIS'],['Ukuran','60×30 – 200×75 mm'],['Tebal','2.3 – 4.5 mm'],['Panjang','6m / 12m']]],
            ...
            <article class="catalog-card" data-cat="{{ $p['cat'] }}">
                ...
                <a href="{{ url('/product/' . $p['slug']) }}" class="catalog-card__img-link">
                    <img
                        src="{{ asset('images/products/' . $p['slug'] . '.svg') }}"
